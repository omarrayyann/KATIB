...
from Other.GameParameters import GameParameters
...
pick_game = pygame.image.load("pickgame.png")
...
# Settings Menu:
sign_out_button = Button.Button('rect', [(100, 200, 100), (50, 100, 50)], (100, 50), 'Sign Out', True, 10, [
                                (255, 255, 255), (200, 200, 50)], (2*screen_width / 15, 2*screen_height / 9))
