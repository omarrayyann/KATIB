...
class Maze:
    ...
    def highlight_current(self, screen, x_start, y_start):
        highlight = pygame.draw.rect(screen, (0, 0, 100), pygame.Rect(self.current.j * self.w + x_start + 2, self.current.i * self.w + y_start + 2, self.w - 4, self.w - 4))
    ...
    def find_solution(self, x_start, y_start):
        ...
        while dist(self.solution_points[len(self.solution_points) - 1], self.solution_points[len(self.solution_points) - 2]) > Maze.min_distance:
