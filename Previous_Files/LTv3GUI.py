...
clear = pygame.image.load('../Media/Images/clear.png').convert()
...
closeL= pygame.image.load('../Media/Images/exit.png').convert()
...
ResetMs= pygame.image.load('../Media/Images/exit.png').convert()
...
gSer.write(str.encode('G21 X90  Y-105 F4000\n'))
print(gSer.readline())
time.sleep(0.1)
gSer.write(str.encode('G10 P1 L20 X0 Y0\n'))
print(gSer.readline())
gSer.write(str.encode('$X\n'))
gSer.write(str.encode(' G21 X0 Y-60.5 F4000\n'))
print(gSer.readline())
gSer.write(str.encode('$X\n'))
gSer.write(str.encode(' G21 X180 Y-60.5 F4000\n'))
print(gSer.readline())
gSer.write(str.encode('$X\n'))
...
#Load check 
            if  e.type == pygame.MOUSEBUTTONDOWN and rectLoad.collidepoint(e.pos):
                ...
                lengthOfarr=len(xp)
                newPoint=pygame.draw.circle(screen, blue, (xp.pop(0),yp.pop(0)), 20)
                flag = 1
                drowOn = False
                drow_on= False
                #pygame.display.flip()
...
# Drawing check
            ...
            if  draw_on and e.type == pygame.MOUSEMOTION and rect.collidepoint(e.pos) and newPoint.collidepoint(e.pos):
                ...
                if lengthOfarr-1>0:
                    ...
                    gcodeString = "G21 X"+"{:.3f}".format(xc)+" Y"+"{:.3f}".format(yc)+" F4000\n"
                    print(gcodeString)
                   ...
                   # sting2send=str(thR)+'\n'
					...
					#thL = -90+thL
					#thR = 90+thR
                    gcodeString = "G21 X"+"0".format(xc)+" Y"+"0".format(yc)+" F4000\n"
                    if(flag==1):
