...
# Quit Button
quit_btn = Button.Button('img', ['Media/Images/exit.png'], (50, 50), 'Exit', False, 50, [(0, 0, 0)], (screen_width * (14 / 15), screen_height * (1 / 9)))
# Return Button
prev_menu_btn = Button.Button('img', ['Media/Images/go-back-arrow.png'], (50, 50), 'Prev', False, 50, [(0, 0, 0)],
                              (screen_width / 15, screen_height / 9))

# Settings Button
settings_btn = Button.Button('img', ['Media/Images/settings.png'], (50, 50), 'Settings', False, 50, [(0, 0, 0)],
...
collect_btn = Button.Button('img', ['Media/Images/catch_sheep.png'], (456, 225), '', False, 50, [(255, 255, 255)],
                            (324 + (456 / 2), 303 + 225 / 2))
maze_btn = Button.Button('img', ['Media/Images/Maze_button.png'], (456, 225), '', False, 50, [(255, 255, 255)],
                         (820 + (456 / 2), 303 + 225 / 2))
handwriting_btn = Button.Button('img', ['Media/Images/Writing_button.png'], (952, 225), '', False, 50, [(255, 255, 255)],
                                (324 + (952 / 2), 568 + 225 / 2))
